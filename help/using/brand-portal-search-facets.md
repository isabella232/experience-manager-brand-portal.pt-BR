...
>[!NOTE]
>
>AEM permite que as organizações [publiquem os formulários de pesquisa personalizados do autor de AEM](../using/publish-schema-search-facets-presets.md#publish-search-facets-to-brand-portal) no Portal de marcas, em vez de recriar o mesmo formulário no Portal de marcas.
...
1. Para acessar as ferramentas administrativas, clique no logotipo AEM na barra de ferramentas na parte superior.
...
1. Na guia **[!UICONTROL Configurações]**, digite um rótulo, um texto de espaço reservado e uma descrição para o predicado de propriedade.
   ...
   * Selecione **[!UICONTROL Pesquisa parcial]**, se desejar permitir a pesquisa parcial de frases (e a pesquisa curinga) de ativos com base no valor da propriedade especificada. Por padrão, o predicado suporta a pesquisa de texto completo.
...
1. No campo **[!UICONTROL Nome da propriedade]**, abra o seletor de propriedades e selecione a propriedade com base na qual a pesquisa é realizada. Como alternativa, insira um nome para a propriedade. Por exemplo, insira `  jcr :content/metadata/dc:title` ou `./jcr:content/metadata/dc:title`.
   ...
   >
   >Qualquer propriedade indexada pode ser usada ao criar um predicado de propriedade. Se qualquer propriedade não indexada estiver configurada, o query de pesquisa em uma propriedade não indexada pode não fornecer nenhum resultado de pesquisa.

   ![](assets/title-prop.png)

1. Clique em **[!UICONTROL Concluído]** para salvar as configurações.
1. Na interface do usuário [!UICONTROL Assets], clique no ícone de sobreposição e escolha **[!UICONTROL Filtro]** para navegar até o painel **[!UICONTROL Filtros]**. O predicado **[!UICONTROL Property]** é adicionado ao painel.

   ![](assets/property-filter-panel.png)

1. Digite um título para o ativo a ser pesquisado na caixa de texto **[!UICONTROL Propriedade]**. Por exemplo, &quot;Adobe&quot;. Quando você realiza uma pesquisa, os ativos com o título correspondente a &quot;Adobe&quot; são exibidos nos resultados da pesquisa.

## Lista de previsões de pesquisa {#list-of-search-predicates}

Semelhante à forma como você adiciona um predicado **[!UICONTROL Property]**, você pode adicionar os seguintes predicados ao painel **[!UICONTROL Filtros]**:
...
| **[!UICONTROL Intervalo de datas]** | Projete de pesquisa para pesquisar ativos criados em um intervalo especificado para uma propriedade de data. No painel Filtros, é possível especificar datas de Start e término. | <ul><li>Rótulo do campo</li><li>Espaço reservado</li><li>Nome da propriedade</li><li>Texto do intervalo (de)</li><li>Texto do intervalo (até)</li><li>Descrição</li></ul> |
...
| **[!UICONTROL Status da retirada]** | O predicado de pesquisa para pesquisar ativos com base no status de check-out de um ativo quando ele foi publicado da AEM Assets. | <ul><li>Rótulo do campo</li><li>Nome da propriedade</li><li>Descrição</li></ul> |
...
| **[!UICONTROL Oculto]** | Este predicado não é explicitamente visível para os usuários finais e é usado para quaisquer restrições ocultas normalmente para restringir o tipo de resultados de pesquisa a **dam:Asset**. | <ul><li>Rótulo do campo</li><li>Nome da propriedade</li><li>Descrição</li></ul> |

>[!NOTE]
>
>Não use **[!UICONTROL Predicado de opções]**, **[!UICONTROL Predicado de status de publicação]** e **[!UICONTROL Predicado de classificação]**, pois esses predicados não estão funcionando no Portal de marcas.
...
1. Na página [!UICONTROL Editar formulário de pesquisa], no painel principal, selecione o predicado que deseja excluir. Por exemplo, selecione **[!UICONTROL Predicado de propriedade]**.
   ...
   A guia **[!UICONTROL Settings]** à direita exibe campos de predicado de propriedade.
...
1. Na interface do usuário **[!UICONTROL Assets]**, clique no ícone de sobreposição e escolha **[!UICONTROL Filtro]** para navegar até o painel **[!UICONTROL Filtros]**. O predicado **[!UICONTROL Property]** é removido do painel.
