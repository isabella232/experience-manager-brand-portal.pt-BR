...
1. No painel **Ferramentas** ![](assets/tools.png) , navegue até **[!UICONTROL Ativos > Usuários do Portal de marcas]**   ![](assets/upload-user-list1.png)
...
1. Clique em **[!UICONTROL Salvar]**.   ![](assets/upload-user-list2.png)
