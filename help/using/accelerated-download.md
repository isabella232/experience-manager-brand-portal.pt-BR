...
* Certifique-se de que a porta 33001 (TCP e UDP) esteja aberta no firewall. Para obter mais informações sobre os pré-requisitos, consulte [Documentação do cliente IBM® Aspera Connect](https://downloads.asperasoft.com/en/documentation/8).
* **Instale o IBM® Aspera Connect 3.9.9** na extensão do navegador usando privilégios de administrador (`https://www.ibm.com/docs/en/aspera-connect/3.9.9`).
...
A tabela a seguir mostra o desempenho de download de um arquivo com 2 GB usando o acelerador de download de arquivo Aspera Connect:
...
| Local do cliente | Latência entre o cliente e o servidor (milissegundos) | Velocidade com o Acelerador de Transferência de Arquivos Assimilar Connect (MBps) | Tempo gasto para baixar um arquivo de 2 GB com o Acelerador de transferência de arquivo inválido (segundos) |
|---------------------------|-----------------------------------|---------------------------------------------|-------------------------------------------------------------------------|
| Oeste dos EUA (N. Califórnia) | 18 | 36 | 57 |
| U.S. West (Oregon) | 42 | 36 | 57 |
| Leste dos EUA (Virgínia) | 85 | 35 | 58 |
...
1. Por padrão, a variável **[!UICONTROL Download rápido]** está ativada na variável **[!UICONTROL Configurações de download]**. Portanto, uma caixa de confirmação é exibida para baixar ativos usando o IBM® Aspera Connect.
   ...
   Se você estiver baixando os ativos pela primeira vez e não tiver o IBM® Aspera Connect instalado em seu navegador ou a versão existente estiver desatualizada, você será solicitado a instalar o Acelerador de download Aspera (`https://www.ibm.com/docs/en/aspera-connect/3.9.9`).
...
1. Para continuar usando **[!UICONTROL Download rápido]**, clique em **[!UICONTROL Permitir]**. Todas as representações selecionadas são baixadas em uma pasta zip usando o IBM® Aspera Connect.
   ...
   Se você não quiser usar o IBM® Aspera Connect, clique em **[!UICONTROL Negar]**. If **[!UICONTROL Download rápido]** for negado ou falhar, o sistema preencherá uma mensagem de erro. Clique no botão **[!UICONTROL Download normal]** para continuar baixando os ativos.
...
Para usar a funcionalidade de download acelerado no Microsoft® Edge, remova o site Brand Portal da lista de sites confiáveis.
...
Existem algumas preferências úteis que podem ser definidas na preferência de cliente do IBM® Aspera Connect clicando com o botão direito do mouse no ícone e selecionando **[!UICONTROL Preferências]**.
