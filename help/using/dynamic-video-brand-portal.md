...
>[!NOTE]
>
>Vídeos dinâmicos não são suportados em locatários do Brand Portal configurados com Autor de AEM em execução no modo de execução **[!UICONTROL Scene7Connect]** .
